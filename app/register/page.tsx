        ...
        >
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 p-10">
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl font-black tracking-tight mb-2">Join the Guide</h1>
              <p className="text-slate-500 dark:text-slate-400">Create your community account</p>
            </div>
            ...
            <div className="mt-10 pt-10 border-t border-slate-50 dark:border-slate-800 text-center">
              <p className="text-slate-500 dark:text-slate-400 text-sm">
                ...
                <Link href="/login" className="text-primary font-black hover:underline uppercase tracking-tighter">Sign in</Link>
              </p>
            </div>
          </div>
        </motion.div>
